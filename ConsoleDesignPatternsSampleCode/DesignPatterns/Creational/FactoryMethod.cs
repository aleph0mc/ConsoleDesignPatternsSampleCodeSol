...
namespace ConsoleDesignPatternsSampleCode.DesignPatterns.Creational
{
    ...
    class PointFactory
    {
        ...
        {
            return new Point(x, y); // needs to be public to be private this constructor needs to be moved into the Point class (see above)
        }
    }
    ...
    public class FactoryMethod
    {
        public static void CreatePoint()
        {
            ...
            var p3 = Point.Factory.NewPolarPoint(1.0, Math.PI / 4.0);

            WriteLine($"Cartesian P: {p2}");
            WriteLine($"Polar P: {p3}");
        }
    }
}
