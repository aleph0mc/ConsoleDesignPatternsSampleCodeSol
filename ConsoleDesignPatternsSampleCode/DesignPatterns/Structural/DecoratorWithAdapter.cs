...
namespace ConsoleDesignPatternsSampleCode.DesignPatterns.Structural
{
    public class MyStringBuilder
    {
        ...
        /// <summary>
        /// Convert a string to MyStringBuilder - Adapter
        /// </summary>
        /// <param name="s"></param>
        ...
        /// <summary>
        /// Add the + operator to MyStringBuilder - Decorator
        /// </summary>
    ...
    public class DecoratorWithAdapter
    {
        public static void CreateAdapterDecorator()
        {
